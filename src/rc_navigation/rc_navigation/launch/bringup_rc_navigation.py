...
def generate_launch_description():
    bringup_dir = get_package_share_directory('rc_navigation')
    ...
    declare_launch_map_server_cmd = DeclareLaunchArgument(
        'launch_map_server',
        default_value='True',
        description='Launch map server and AMCL for localization debugging')

    declare_launch_navigation_cmd = DeclareLaunchArgument(
        'launch_navigation',
        default_value='True',
        description='Launch the navigation stack for debugging')

    declare_launch_rviz_cmd = DeclareLaunchArgument(
        'launch_rviz',
        default_value='True',
        description='Launch RViz for debugging')
    ...
    ld.add_action(declare_launch_navigation_cmd)
